...
(function() {
  jQuery(document).ready(function() {
    ...
    $('.BottomLink').hide();
    return $('#VinylCollection').slideDown(1000, function() {
      return $('.BottomLink').fadeIn(400);
    });
  });

  $('.delete_vinyl').bind('ajax:success', function() {
    return $(event.target).parent().parent().fadeOut(1000);
  });
